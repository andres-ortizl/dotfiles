  ...
  case "$1" in
    homeserver.env)
      validate_env_names "$2" \
        "DOMAIN PUID PGID TZ DATA_ROOT UPLOAD_LOCATION DB_PASSWORD DB_USERNAME DB_DATABASE_NAME PIHOLE_PASSWORD PIHOLE_DNS PIHOLE_API_KEY TS_AUTHKEY" \
        "DOMAIN PUID PGID TZ DATA_ROOT UPLOAD_LOCATION DB_PASSWORD DB_USERNAME DB_DATABASE_NAME PIHOLE_PASSWORD PIHOLE_DNS PIHOLE_API_KEY TS_AUTHKEY" 0 \
